...
<div class="modal fade" id="editUser_{{ $id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    @php
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.update', ['S_ID' => $Users->S_ID]) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="PASSWORD" id="passwordA{{ $i }}" @if
