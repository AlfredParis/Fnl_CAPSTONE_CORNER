...
<ul class="nav nav-pills flex-column mt-4 ">
    <li class="nav-item py-2 py-sm-0">
        <a href="{{ route('studentt.index') }}" class="nav-link text-white" ><i class="fs-5 fa fa-house"></i><span class="fs-4 d-none ms-2 d-sm-inline">Dashboard</span></a>
    </li>
    <li class="nav-item py-2 py-sm-0">
        <a href="{{ route('studentt.myArchive') }}" class="nav-link text-white active" aria-current="true"><i class="fs-5 fa fa-box-archive"></i><span class="fs-4 d-none ms-2 d-sm-inline">My Archive</span></a>
    </li>
    <li class="nav-item py-2 py-sm-0">
